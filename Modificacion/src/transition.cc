 ...
 * @brief This file contains the implementation of the transition class.
 * @version 0.1
 * @date 2022-11-10
 ...
 */
std::string Transition::getTransitionSymbol() { return transition_symbol_; };
 ...
 */
std::string Transition::getTransitionState() { return transition_; };

/**
 * @brief This method returns the transition.
 *
 */
std::string Transition::at() { return transition_; };