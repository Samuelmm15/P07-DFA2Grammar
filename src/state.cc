 ...
 */
void State::setState(std::string state_number) { state_ = state_number; };
 ...
 */
void State::setFinalState(bool final_state) { final_state_ = final_state; };
 ...
 */
std::string State::getState() { return state_; };
 ...
 */
bool State::getFinalState() { return final_state_; };
 ...
 */
std::vector<Transition> State::getTransition() { return transitions_; };

int State::getNumberTransitions() { return number_of_transitions_; };
